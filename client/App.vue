<template>
  <LoadingIndicator
    ...
    class="flex h-screen flex-col overflow-hidden px-4 py-4 print:h-auto print:overflow-visible print:max-w-full"
  >
    <PrimeToast />
    ...
    />
    <div class="min-h-0 flex-1 overflow-hidden print:overflow-visible">
      <RouterView />
    </div>
  </LoadingIndicator>
</template>
